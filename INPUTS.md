...
## listening
The sample question is shown below, where there are five fields in total: `context` (the transcript got using automatic speech recognition), `context_oracle` (the gold transcript), `question`, `options`, and `answer`. 
```json
{
